...
from app.models import User, AnalysisReport, TTP, Signature, Screenshot, ExtractedData

# Create tables if they don't exist
with app.app_context():
    db.connect()
    db.create_tables([User, AnalysisReport, TTP, Signature, Screenshot, ExtractedData], safe=True)
    db.close()
